...
public class StudentsAttendanceController implements Initializable {
	...
	private void showAttendance (String staffName){
		...
		ObservableList<StaffAttendanceRecord> items =SQLConnector.getStudentsAttendanceReport(staffName);
		Boolean foundYear = false;
		Boolean foundMonth = false;
		Boolean foundDay = false;
		
		TreeItem<String> rootNode = 
		        new TreeItem<String>(staffName + " Attendance Data");
